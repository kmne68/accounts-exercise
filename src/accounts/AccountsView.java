...
//    Checking ckacct;
    ...
    private void jbtnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCreateActionPerformed
       ...
       NumberFormat curr = NumberFormat.getCurrencyInstance();
        ...
        switch (jtxtTypeCd.getText()){
            case Savings.TYPECD:
                assetAccount = new Savings(jtxtAcctNm.getText(),sbal);
            ...
            case Checking.TYPECD:
                ...
                jtxtDisplayName.setText(assetAccount.getName());
                jtxtAcctNo.setText(String.valueOf(assetAccount.getAcctNo()));
                jtxtAcctTypeCd.setText(Checking.TYPECD);
                jtxtAcctTypeDesc.setText(Checking.TYPEDESC);
                jtxtBalance.setText(curr.format(assetAccount.getBalance()));
                break;
            default:
                statusMessageLabel.setText(
    ...
    private void jbtnChgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnChgActionPerformed
        ...
        //    if (jtxtAcctTypeCd.getText().equalsIgnoreCase(Checking.TYPECD)) {
                assetAccount.setCharge(amt, jtxtChgDesc.getText());
                if (assetAccount.getErrMsg().isEmpty()) {
                    statusMessageLabel.setText(assetAccount.getActionMsg());
                    jtxtBalance.setText(curr.format(assetAccount.getBalance()));
                } else {
                    statusMessageLabel.setText(assetAccount.getErrMsg());

       //     } else if (jtxtAcctTypeCd.getText().equalsIgnoreCase(Savings.TYPECD)) {
            } /* else if (assetAccount instanceof Savings) {
                    svacct.setCharge(amt, jtxtChgDesc.getText());
                if (svacct.getErrMsg().isEmpty()) {
                    statusMessageLabel.setText(svacct.getActionMsg());
                    jtxtBalance.setText(curr.format(svacct.getBalance()));
                } else {
                    statusMessageLabel.setText(svacct.getErrMsg());
                }
            } else {
